...
echo ""
echo "Next steps:"
echo "  1. Deploy source connector (waits for DB2 automatically):"
echo "     ./deploy-source-connector.sh"
echo ""
echo "  2. Deploy Flink merge job:"
echo "     ./deploy-flink-merge.sh"
echo ""
echo "  3. Deploy Flink averaging job:"
echo "     ./deploy-flink-avg.sh"
echo ""
echo "  4. Deploy sink connectors:"
echo "     ./deploy-sink-connectors.sh"
echo ""
